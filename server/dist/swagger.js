...
const swaggerSpecification = {
    ...
    info: {
        ...
        version: '0.1.0',
        description: 'Crafts Platform backend API for user registration, login, email verification, and admin user management.\n\n' +
    ...
    servers: [
        {
            url: config_1.config.urls.server,
...
function setupSwagger(app) {
    const controllersGlob = path_1.default.join(__dirname, 'controllers', '*.ts');
    const spec = (0, swagger_jsdoc_1.default)({ definition: swaggerSpecification, apis: [controllersGlob] });
    app.use('/api/docs', swagger_ui_express_1.default.serve, swagger_ui_express_1.default.setup(spec, swaggerUiOptions));
}
